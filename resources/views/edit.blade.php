...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto bg-white shadow-2xl rounded-3xl overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
            <h1 class="text-4xl font-extrabold text-white text-center">Edit Reminder</h1>
        </div>

        <form action="{{ route('reminders.update', $reminder->id) }}" method="POST" class="p-10 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-full">
                    ...
                    <input 
                        ...
                        name="reminder_time" 
                        id="reminder_time" 
                        value="{{ \Carbon\Carbon::parse($reminder->reminder_time)->format('Y-m-d\TH:i') }}" 
                        class="
                            w-full 
                            px-4 
                            py-3 
